...
<tr>
<td style="background-color: """+ left_col_color +""";"><span style="color: #ffffff;">Distance to center (KM)</span></td>
...
def popup_center_item(latitude,
               longitude,
               labels,
               mean_weighted_attr=None):
...
<html>
<head>
<h4 style="margin-bottom:10"; width="200px">Center {}</h4>""".format(labels+1) + """
</head>
    <table style="height: 126px; width: 350px;">
<tbody>
<tr>
